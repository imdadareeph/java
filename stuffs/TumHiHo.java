...
/* Construct a sequence of MidiEvents containing NOTE_ON/NOTE_OFF
   ...
   (e.g. F4#). See http://imdadareeph.org/TumHiHo
...
public class TumHiHo implements MetaEventListener 
{
  ...
  public TumHiHo()
  {
    ...
    startSequencer(50);   // tempo: 60 beats/min
 ...
 public void intro(){
	for(int i=0;i<=1;i++){
	add("F3"); add("G4#"); add("C5"); add("G4#"); 
	add("C5#"); add("G4#"); add("A4#"); add("G3"); 
	}
 }

//Hum tere bin ab reh nahi shaktey tere bina kiya wajood mera 
public void verse(){
	for(int i=0;i<1;i++){
	add("F1"); add("C2"); add("G4#"); add("F3"); 
	add("F6"); add("C5"); add("G4#"); add("F3");

	add("A2#"); add("F3"); add("A4#"); add("F3"); 
	add("F6"); add("C5#"); add("A4#"); add("F3");

	add("D3#"); add("A4#"); add("D5#"); add("A4#"); 
	add("G6"); add("D5#"); add("A4#"); add("D3#");

	add("C2#"); add("F3"); add("G4#"); add("F3"); 
	add("F6"); add("C5#"); add("G4#"); add("F3");
	}
 }

//kyunki tum hi ho, ab tum hi ho, jindegi ab tum hi ho
  public void chorus(){
	add("G4#"); add("A4#"); add("C5"); addRest(1);add("G4#"); add("A4#");addRest(1);
	add("G4#"); add("A4#"); add("C5"); add("A4#");addRest(1); add("G4#"); add("A4#");addRest(1);
	add("G3");addRest(1);  add("A4#"); add("G4#");//addRest(1);
	add("G3");  add("F3");  add("G3"); add("F3"); add("D3#");  add("F3"); 
 }
  ...
  */
  { changeInstrument(0,33);    // set bank and program; bass
	...
	intro();intro();
	verse();intro();
	changeInstrument(0,10);   // dulcimer
	verse();verse();
